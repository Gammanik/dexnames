...
Пользователь может выставить имя на продажу. Для выставления имени нужно указать {"account4sale","saleprice", "paymentaccnt", "message"} и подписаться ключом от аккаунта который выставлен на продажу. 
